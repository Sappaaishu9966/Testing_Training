...
class Result12 {
	...
	Result12(String Pname,int Page,String PName1){
...
class Child_practice12 extends Result12 {
	...
	Child_practice12(String Cname, int Cage, String Caddress, int Csalary,String Cname1) {
